...
public class DbInitializer {
    ...
    private static final String[] queries = {
        ...
        "projekt_id INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1), " +
        ...
        "zadanie_id INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 1), " +
        "nazwa VARCHAR(50) NOT NULL, " +
        "opis VARCHAR(1000), " +
        "kolejnosc INTEGER, " +
        "dataczas_utworzenia TIMESTAMP DEFAULT now(), " +
    ...
    public static void init() {
        try (Connection conection = DataSource.getConnection()) {
            ...
            try (Statement stmt = conection.createStatement()) {
                ...
                conection.setAutoCommit(initialAutocommit);
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
